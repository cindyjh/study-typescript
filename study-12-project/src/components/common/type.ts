...
/**
 * Set of callbacks that a draggable component must implement to get notified when dragging starts and end.
 */
...
/**
 * Set of callbacks that a component needs to implements to receive drops of dragged items
 */
